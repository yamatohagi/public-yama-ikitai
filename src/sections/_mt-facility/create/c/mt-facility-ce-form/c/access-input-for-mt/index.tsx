...
import {MountainToMtFacilityCreateWithoutMtFacilityInputSchema} from 'server/routers/mt-facility/schemas/objects/MtFacilityCreateInput.schema';
...
export default function AccessInputForMt({methods}: AccessInputProps) {
    ...
    <Grid item xs={12} sm={12} sx={{mt: 1.5}}>
      ...
      <Grid item xs={12} sm={12}>
        <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
          <IconButton onClick={() => append(defaultInstance(MountainToMtFacilityCreateWithoutMtFacilityInputSchema))} style={{color: '#367B9D'}}>
