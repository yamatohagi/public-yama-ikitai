...
export default function TypeInput({dividerCss}: {dividerCss: string}) {
  ...
  return (
    <>
      <Grid item xs={12} sm={12} sx={{mt: 1.5}}>
        ...
        <RHFCheckboxGroup name="MtFacilityTypeIds" options={list?.map((obj) => ({label: obj.name, value: obj.id})) || []} />
      </Grid>
