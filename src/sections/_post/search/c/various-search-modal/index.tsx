...
const filters = [
  {
    ...
    name: '登山時間',
    options: [
      {value: 'lessThanTwo', label: '2時間未満'},
      {value: 'twoToFour', label: '2~4時間'},
      {value: 'fourToSix', label: '4~6時間'},
      {value: 'sixToEight', label: '6~8時間'},
      {value: 'moreThanEight', label: '8時間以上'},
    ],
  },
];
...
const Modal = () => {
  ...
  const {liveState, setLiveValueByKey, applyFilters} = usePostFilterStore();
...
export const VariousSearchModal = memo(Modal);
