...
import usePostCreateForm, {PostInput} from 'src/components/post/create/floating-button-for-flexible-input/modal-inner/hooks';
...
function PostCreateModalInner({refresh, viewTitle, closeModal}: PostCreateModalProps) {
  ...
  return <PostCreateModalFlexibleForm methods={methods} onSubmit={onSubmit} viewTitle={viewTitle} closeModal={closeModal} />;
}
